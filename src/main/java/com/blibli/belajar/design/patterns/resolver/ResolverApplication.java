    ...
    public static class Application {
        ...
        public static class MandatoryParameterArgumentResolver implements HandlerMethodArgumentResolver {
            ...
            public boolean supportsParameter(MethodParameter methodParameter) {
                return MandatoryParameter.class.isAssignableFrom(methodParameter.getParameterType());
            }

            @Override
            public Object resolveArgument(MethodParameter methodParameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest nativeWebRequest, WebDataBinderFactory webDataBinderFactory) throws Exception {
                System.out.println("Resolving arguments");
                return MandatoryParameter.builder()
                        .requestId(nativeWebRequest.getHeader("X-Request-Id"))
                        .userId(nativeWebRequest.getHeader("X-User-Id"))
                        .serviceId(nativeWebRequest.getHeader("X-Service-Id"))
                        .timestamp(Long.valueOf(nativeWebRequest.getHeader("X-Timestamp")))
                        .build();
            }
        }
        ...
        public static class SampleController {
            ...
            public Member getMember(@PathVariable("id") String memberId, MandatoryParameter mandatoryParameter) {
                System.out.println(mandatoryParameter);
                return Member.builder().id(memberId).name("Emmanuel").build();
            }
